...
import logo2 from "../../assets/nav-icons/recruiter.svg";
...
const ApplicationBuilder: React.FC = () => {
  ...
  const [tab, setTab] = useState("tailor_applicant");
                    ...
                    <NavLink
                      ...
                      className={`group relative flex items-center gap-2.5 font-medium rounded-sm  ${
                        !sidebarOpen ? "px-4 py-2" : "pl-5 py-3"
                             ...
                             text-[#4d4d4d] hover:bg-recruiter/15 hover:text-recruiter`}
                    >
                      <AiOutlineHome className="w-4.5 h-4.5" />
                      {!sidebarOpen && "Talent Hub"}
                      <p className="block lg:hidden">Talent Hub</p>
                    </NavLink>
                  </li>
                  <li>
                    <motion.div
                    ...
                    >
                      ...
                      >
                        <motion.li
                          ...
                          //   onClick={onClick}
                          className={`font-medium whitespace-nowrap rounded-full my-3 border p-2  border-[#8343CC] ${
                            tab === "apply_all"
                              ? "text-recruiter bg-recruiter/15 hover:bg-recruiter/90 hover:text-white"
                              : "hover:bg-recruiter/15 hover:text-recruiter text-recruiter"
                        ...
                        <motion.li
                          variants={itemVariants}
                          onClick={() => setTab("tailor_applicant")}
                          className={`flex items-center gap-2 py-2 px-4 font-medium whitespace-nowrap rounded-md ${
                            tab === "tailor_applicant"
                              ? "text-recruiter bg-recruiter/15 hover:bg-recruiter/90 hover:text-white"
                              : "hover:bg-recruiter/15 hover:text-recruiter text-[#4d4d4d] "
                          }   transition-colors cursor-pointer`}
                        >
                          <div className="flex items-center">
                            <span className="mr-2">{<Icons.bolt />}</span>
                            Tailor Applicant
                          </div>
                        </motion.li>
                        <motion.li
                        ...
                        >
                          <div className="flex items-center">
                            <span className="mr-2">{<Icons.draft />}</span>
                            Evaluation Criteria
                          </div>
                        </motion.li>
                        ...
                        >
                          <div className="flex items-center">
                            <span className="mr-2">{<Icons.question />}</span>
                        ...
                        >
                          <div className="flex items-center">
                            <span className="mr-2">{<Icons.personInfo />}</span>
          ...
          <main>
            <div className="mx-auto">
              ...
              <div className="pb-6 px-4 md:px-6">
                {tab === "tailor_applicant" ? <AppBuilder /> : ""}{" "}
